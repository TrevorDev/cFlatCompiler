...
sw	$a0, -48($fp)	#store variable ___temp45 in local variable ___temp45
#Inline puti
lw      $a0,-48($fp)
li      $v0, 1
syscall
...
sw	$a0, -72($fp)	#store variable ___temp51 in local variable ___temp51
#Inline puti
lw      $a0,-72($fp)
li      $v0, 1
syscall
...
li	$a0,1
sw	$a0, -76($fp)
lw	$a0,-76($fp)	#load global variable ___temp52 to register $a0
#reset sp and fp and return
move    $sp,$fp
lw      $ra, 0($fp)
lw      $fp, 4($fp)
